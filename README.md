# HISTEX
- This repository contains the implementation for our work "Inferring Super-Resolved Gene Expression by Integrating Histology Images and Spatial Transcriptomics with HISTEX", accepted by **MICCAI 2025**
## Introduction
